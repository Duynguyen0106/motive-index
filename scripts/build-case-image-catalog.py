...
CASE_SEARCHES: dict[str, list[str]] = {
    ...
    "antonis-daglis": ["Athens Greece courthouse", "Athens Greece"],
    ...
    "karol-kot": ["Krakow Poland courthouse", "Krakow Poland old town"],
    ...
    "richard-klinkhamer": ["Groningen Netherlands courthouse", "Groningen Netherlands"],
    "louay-al-taei": ["Baghdad Iraq courthouse", "Baghdad Iraq"],
    "kang-ho-sun": ["Suwon South Korea courthouse", "Seoul South Korea courthouse"],
    "somkid-pumpuang": ["Bangkok Thailand courthouse", "Khon Kaen Thailand"],
    ...
    "andras-pandy": ["Brussels Belgium courthouse", "Brussels Belgium"],
    "romulus-veres": ["Cluj Napoca Romania courthouse", "Cluj Napoca Romania"],
    ...
    "ershad-sikder": ["Khulna Bangladesh courthouse", "Khulna Bangladesh"],
    "le-van-luyen": ["Bac Giang Vietnam courthouse", "Bac Giang Vietnam"],
}
