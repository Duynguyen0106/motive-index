...
CASE_SEARCHES: dict[str, list[str]] = {
    ...
    "javed-iqbal": ["Lahore High Court", "Lahore Pakistan courthouse"],
    "javed-iqbal-urdu": ["Lahore High Court", "Lahore Pakistan courthouse"],
    "saeed-hanaei": ["Mashhad Iran city", "Mashhad Iran"],
    ...
    "pedro-lopez": ["Pedro Lopez mugshot Colombia", "Bogota Colombia courthouse"],
    ...
    "mira-bare": ["Prague Czech Republic courthouse", "Prague Old Town"],
    "mona-fandey": ["Kuala Lumpur courthouse", "Kuala Lumpur city"],
    "amrozi-nurhasyim": ["Bali bombing memorial", "Denpasar Bali Indonesia"],
    "yishai-schlissel": ["Jerusalem Israel courthouse", "Jerusalem Old City"],
    ...
    "volkmar-heinrich": ["Santiago Chile courthouse", "Santiago Chile city"],
    "abimael-guzman": ["Abimael Guzman mugshot", "Lima Peru courthouse"],
    "krzysztof-gawlik": ["Wroclaw Poland courthouse", "Wroclaw Poland city"],
    "werner-fischer": ["Bern Switzerland courthouse", "Zurich Switzerland courthouse"],
    "nguyen-thanh-vu": ["Ho Chi Minh City courthouse", "Ho Chi Minh City Vietnam"],
    "andres-bustamante": ["Cebu Philippines courthouse", "Cebu City Philippines"],
    "gheorghe-solovan": ["Bucharest Romania courthouse", "Bucharest Romania"],
    "mehmet-oktas": ["Ankara Turkey courthouse", "Ankara Turkey"],
    "dimitris-papageorgiou": ["Athens Greece courthouse", "Athens Greece"],
    ...
    "abdul-latif-rashid": ["Baghdad Iraq courthouse", "Baghdad Iraq"],
