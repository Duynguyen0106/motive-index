...
const HAND_CURATED_REFERENCE_OVERRIDES: Record<string, CaseReference[]> = {
  ...
  "zodiac-killer": [
    ...
    {
      id: "ref-zodiac-fbi",
      citation: "Public record summaries — Zodiac Killer investigation (local and federal cooperation).",
      kind: "report",
      url: "https://en.wikipedia.org/wiki/Zodiac_Killer#Investigation",
      note: "Multi-agency investigative record; see FBI Vault for digitized federal assistance files.",
    },
  ],
  "timothy-mcveigh": [
    {
  ...
  "louay-al-taei": [
    ...
    },
    {
      ...
      note: "Healthcare-trust predation in a conflict hospital; cross-check victim counts with Arabic court files.",
    },
  ],
  "krzysztof-gawlik": [
    {
