    ...
    <div className="dossier-action-bar" role="region" aria-label="Quick case actions">
      <div className="site-shell flex items-center justify-between gap-3 py-2.5">
        ...
        <div className="flex shrink-0 flex-wrap justify-end gap-1.5">
          ...
          <Link href={searchUrlFromFilters(searchSimilar)} className="btn btn-ghost px-2.5 py-1 text-xs">
            Similar
          </Link>
          <Link href={`/live?country=${country}`} className="btn btn-ghost px-2.5 py-1 text-xs">
            News
          </Link>
